...
class AdvanceImagePicker extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return AdvanceImagePickerState();
  }
}

class AdvanceImagePickerState
    extends State<AdvanceImagePicker> {
  File image;
